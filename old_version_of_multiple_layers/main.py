...
y_e = np.array([layer_y_position(i, number_of_layers) for i in range(number_of_layers)])
...
for step in range(TIME_STEPS):
    ...
    for y_p_val in y_f:
        ...
        ax.quiver(x_p_val, y_p_val, z_p_val, 0, 0, ef_combined, color='m', alpha=0.1)
        ax.quiver(x_p_val, y_p_val, z_p_val, 0, 0, ef_original, color='g', alpha=0.2)
        #ax.quiver(x_p_val, y_p_val, z_p_val, 0, 0, ef_due_to_electrons, color='b', alpha=0.2)
